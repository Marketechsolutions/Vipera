...
__d("SearchResultPageLoggingInlineActionFalcoEvent", ["FalcoLoggerInternal", "getFalcoLogPolicy_DO_NOT_USE"], (function(a, b, c, d, e, f, g) {
    "use strict";
    a = c("getFalcoLogPolicy_DO_NOT_USE")("1744351");
    b = d("FalcoLoggerInternal").create("search_result_page_logging_inline_action", a);
    e = b;
    g["default"] = e
}), 98);
__d("SearchResultPageLoggingItemClickedFalcoEvent", ["FalcoLoggerInternal", "getFalcoLogPolicy_DO_NOT_USE"], (function(a, b, c, d, e, f, g) {
    "use strict";
    a = c("getFalcoLogPolicy_DO_NOT_USE")("1744352");
    b = d("FalcoLoggerInternal").create("search_result_page_logging_item_clicked", a);
    e = b;
    g["default"] = e
}), 98);
...
__d("MsiteFullViewFalcoEvent", ["FalcoLoggerInternal", "getFalcoLogPolicy_DO_NOT_USE"], (function(a, b, c, d, e, f, g) {
    "use strict";
...
__d("FullViewLogger", ["Banzai", "MsiteFullViewFalcoEvent", "ScriptPath", "SubscriptionsHandler", "URI", "killswitch", "uuidv4"], (function(a, b, c, d, e, f, g) {
    var h;
    a = function() {
        function a() {}
...
__d("MsiteViewabilityFalcoEvent", ["FalcoLoggerInternal", "getFalcoLogPolicy_DO_NOT_USE"], (function(a, b, c, d, e, f, g) {
    "use strict";
...
__d("ViewabilityDurationSegmentLogger", ["Banzai", "MsiteViewabilityFalcoEvent", "PercentVisible", "killswitch", "uuidv4"], (function(a, b, c, d, e, f, g) {
    "use strict";
    var h = 8e3;
    a = function() {
        a.logFromViewableImpressionTracker = function(b) {
...
__d("CometMetricsChannel2ViewabilityFalcoEvent", ["FalcoLoggerInternal", "getFalcoLogPolicy_DO_NOT_USE"], (function(a, b, c, d, e, f, g) {
    "use strict";
    a = c("getFalcoLogPolicy_DO_NOT_USE")("1960868");
    b = d("FalcoLoggerInternal").create("comet_metrics_channel2_viewability", a);
    e = b;
    g["default"] = e
}), 98);
...
__d("FeedAdXoutEventTracker", [], (function(a, b, c, d, e, f) {
    "use strict";
    var g = new Set();
...
__d("GHLTestElement", ["csx", "invariant", "ODS", "Parent", "URI", "containsNode", "getElementPosition", "gkx"], (function(a, b, c, d, e, f, g, h) {
    ...
    var k = function(a) {
        ...
        n = function(a) {
            return (j || (j = b("ODS"))).bumpEntityKey(2966, "feed_ads", "GHLTestElement.testElementI." + a)
        };
    e.exports = {
        testElementI: a
    }
}), null);
__d("MsiteViewableImpressionFalcoEvent", ["FalcoLoggerInternal", "getFalcoLogPolicy_DO_NOT_USE"], (function(a, b, c, d, e, f, g) {
    "use strict";
...
__d("NonBlockingIFrame", ["Promise", "TimeSlice", "cr:6114"], (function(a, b, c, d, e, f) {
    var g, h = {},
        i, j;
    ...
    function l() {
        return new(g || (g = b("Promise")))(function(a) {
            i || (i = k()), i.contentDocument.readyState === "complete" ? a(i) : (j || (j = new(g || (g = b("Promise")))(function(a) {
...
__d("ViewableImpressionTracker", ["csx", "cx", "AdImpressionLoggingConfig", "Banzai", "CometMetricsChannel2ViewabilityFalcoEvent", "DataAttributeUtils", "FBFeedImpressionTopMarginGetter", "FBImpressionValidationUtils", "FeedAdXoutEventTracker", "GHLDelay", "GHLTestElement", "MsiteViewableImpressionFalcoEvent", "NonBlockingIFrame", "ODS", "PercentVisible", "Run", "ScriptPath", "Style", "URI", "ViewabilityFramework", "Visibility", "WebSession", "cr:1095627", "cr:4095", "cr:4394", "cr:6114", "cr:7058", "ge", "getCentralImpressionTimeAfterRefresh", "getElementPosition", "getViewportDimensions", "ghlTestUBT", "gkx", "isImpressionTargetOccluded", "killswitch", "mixInEventEmitter", "randomInt", "uuidv4"], (function(a, b, c, d, e, f, g, h, i) {
    var j, k, l = null;
    a = function() {
        function a(a, b, e) {
            var f = this;
            this.checkAndLogImpressionIfPendingOnExit = function() {
                c("AdImpressionLoggingConfig").enableFlushDelayLogOnCleanup && f.waitForDelayLogged && (window.clearTimeout(f.delayedLoggingTimeout), f.delayLogImpression())
            };
        ...
        e.$4 = function(a, c, d, e) {
            d === void 0 && (d = 0);
            e === void 0 && (e = !1);
            return this.config.require_horizontally_onscreen && b("cr:4095").isHorizontallyOffscreen(this.element, c, a) ? {
                rects: {
                    target_rect: c
                },
                percentage: 0,
        ...
        e.onVisible = function(a) {
            ...
            this.config.log_viewability_events_for_infra_validation && this.$10(l, h, i, j, g);
            var m = [];
            i = [];
            (this.config.skip_imp_if_no_images || this.config.check_images_before_log) && (m = Array.from(this.element.querySelectorAll("img")), i = Array.from(this.element.getElementsByClassName("_7cqq")), (k || (k = d("ODS"))).bumpEntityKey(2966, "feed_ads", "ViewableImpressionTracker.delayLogImpression.isFeedLoadedCheck." + (m.length === 0) + "." + (i.length === 0)));
            ...
            if ((this.config.client_no_dedup ? g : this.isVisible) && !this.waitForLogged && !this.waitForDelayLogged && !this.isLogged()) {
                i = function() {
                    ...
                    b.config.check_images_before_log && (m.length === 0 && (k || (k = d("ODS"))).bumpEntityKey(2966, "feed_ads", "ViewableImpressionTracker.log_without_load." + b.config.trackable_identifier));
                    if (c("GHLDelay").getEnabled() && b.config.can_delay_log_impression === !0) {
                        ...
                        a < 0 && (a = 0);
                        b.delayedLoggingTimeout = window.setTimeout(b.delayLogImpression, a)
                    } else b.logImpression(1, !1, {}), b.$12()
                };
                this.waitForLogged = !0;
                this.viewableTimeout = window.setTimeout(i, this.config.duration_in_ms)
            }
        };
        ...
        e.onHidden = function(a) {
            ...
            this.isHidden || (this.isHidden = !0, this.lastInvisibleReason = "NOT_IN_VIEWPORT", b("cr:1095627") && b("cr:1095627").onItemExitViewport(c("ViewabilityFramework").VIEWABLE_TRACKER_BLUE, this.element));
            this.emit("hidden", {
                id: this.getID(),
                token: this.getToken()
            });
            ...
            this.handleLogNonViewableOnInvisible(a);
            this.isVisible = !1;
            this.waitForLogged && (this.waitForLogged = !1, window.clearTimeout(this.viewableTimeout));
            this.config.client_no_dedup && this.config.subsequent_gap_in_ms === 0 && this.config.client_track_subsequent_impression ? this.reset() : this.isLogged() && !this.waitForSubsequent && this.config.subsequent_gap_in_ms >= 0 && this.config.client_track_subsequent_impression && (this.waitForSubsequent = !0, this.clearSubsequentTimeout = window.setTimeout(function() {
        ...
        e.logViewabilityEventsForAudit = function(a, e, f, g) {
            var h = this,
                ...
                r = c("uuidv4")(),
                s = this.config.is_rhc ? c("ViewabilityFramework").VIEWABLE_TRACKER_BLUE_RHC : c("ViewabilityFramework").VIEWABLE_TRACKER_BLUE;
        ...
        e.logImpression = function(a, e, f) {
            ...
            if (this.config.should_batch || this.config.vital_mode_for_ss || this.config.signal_mode_for_ss) {
                ...
                a = this.config.vital_mode_for_ss ? babelHelpers["extends"]({}, c("Banzai").VITAL) : {};
            ...
            if (c("gkx")("21109")) try {
                ...
                (k || (k = d("ODS"))).bumpEntityKey(2966, "impression_logging_debug", "viewable_session_validation_exception." + a.message)
            }
        };
        ...
        e.reset = function() {
            this.iframeLogged && (this.iframeLogged = !1), this.iframe && (b("cr:6114").remove(this.iframe), this.iframe = null), this.banzaiLogged && (this.banzaiLogged = !1), this.falcoLogged && (this.falcoLogged = !1), this.isNonViewableLogged = !1, this.isVisible = !1, this.waitForLogged = !1, this.waitForDelayLogged = !1, this.waitForSubsequent = !1
        };
        e.logWithFalco = function(a) {
            ...
            c("killswitch")("MSITE_STOP_IMPS_LOGGING_VIA_FALCO") || (this.falcoLogged = !0, c("MsiteViewableImpressionFalcoEvent").logImmediately(function() {
                ...
                return {
                    ...
                    me: a.me,
                    fbfeed_location: String(c("FBImpressionValidationUtils").getFBFeedLocation(b.element)),
        ...
        e.logWithBanzai = function(a, d) {
            this.banzaiLogged = !0, b("cr:7058").maybeLogClientViewEvent(a), c("Banzai").post("xtrackable:clientview_batch", a, d)
        };
        e.logWithIFrame = function(a) {
            this.iframeLogged = !0, this.config.is_instream_story ? c("NonBlockingIFrame").loadIFrame(new(j || (j = c("URI")))(this.config.impressionURL).addQueryData(a).toString()) : (this.iframe = b("cr:6114").create("iframe", {
                src: new(j || (j = c("URI")))(this.config.impressionURL).addQueryData(a).toString(),
                width: 0,
                height: 0,
                frameborder: 0,
                scrolling: "no",
                className: "fbEmuTracking"
            }), this.iframe.setAttribute("aria-hidden", "true"), b("cr:6114").appendContent(this.element, this.iframe))
        };
        e.$15 = function() {
        ...
        e.$16 = function() {
            ...
            if (a) {
                ...
                c("gkx")("21110") ? d = c("ge")("m_news_feed_stream") : d = c("ge")("m_newsfeed_stream");
...
__d("VisibilityTracking", ["Banzai", "DataAttributeUtils", "ErrorUtils", "ScriptPath", "SubscriptionsHandler", "Visibility", "collectDataAttributes", "cr:4867", "cr:7058", "getElementPosition", "gkx", "pageID", "throttle"], (function(a, b, c, d, e, f, g) {
    var h, i = "visibility_tracking",
        j = "[data-vistracking]",
        k = 500,
        l = 50,
        m = 50,
    ...
    a = function() {
        ...
        d.isVisible = function(a, d) {
            if (a == null) return !1;
            if (c("gkx")("20872") && b("cr:4867").isSnippetFlyoutVisible()) return !1;
            a = c("getElementPosition")(a);
            return !!(a.x || a.y || a.width || a.height) && a.y + a.height >= this.minOffsetVisibleFromTop && a.y <= d.height - this.minOffsetVisibleFromBottom && a.x + a.width >= this.minOffsetVisibleFromLeft && a.x <= d.width - this.minOffsetVisibleFromRight
        };
        ...
        d.onUnload = function() {
            this.addCauseToAllHiddenEvents ? this.clearAllVisibleElements("unload") : this.clearAllVisibleElements(), this.listeners && (this.listeners.release(), this.listeners = null), this.extraCleanup && (h || (h = c("ErrorUtils"))).applyWithGuard(this.extraCleanup.bind(this))
        };
        a.init = function(b) {
            return new a(b)
        };
...
__d("ViewableImpressionTracking", ["Arbiter", "DesktopHscrollUnitEventConstants", "ErrorUtils", "LitestandMessages", "Run", "ViewableImpressionConfig", "ViewableImpressionEventHandler"], (function(a, b, c, d, e, f, g) {
    ...
    function a() {
        c("ViewableImpressionEventHandler").instance === void 0 && (c("ViewableImpressionEventHandler").instance = new(c("ViewableImpressionEventHandler"))(c("ViewableImpressionConfig")), c("ViewableImpressionEventHandler").instance.listeners != null && c("ViewableImpressionEventHandler").instance.listeners.addSubscriptions(c("Arbiter").subscribe([c("LitestandMessages").STORIES_INSERTED, "MPPInsights/ChartView", "PhotoSnowliftAds/displayUnits", "WebMessengerAdsControl/adjustAds", d("DesktopHscrollUnitEventConstants").HSCROLL_ITEM_INSERTED_EVENT, "WebVideoChannelAds/AdsLoaded", "Stories/cardChanged"], (h || (h = c("ErrorUtils"))).guard(function(a) {
...
__d("getCentralImpressionScrollSpeed", ["cr:5662"], (function(a, b, c, d, e, f) {
    "use strict";
    var g = 0,
        h = Date.now(),
        i = null,
    ...
    function a(a) {
        b("cr:5662").listen(window, "scroll", function() {
...
__d("ViewableSessionStore", ["ODS", "ViewableSessionValidationWebResultTypedLogger", "ge", "getCentralImpressionScrollSpeed", "getCentralImpressionTimeAfterRefresh", "getViewportDimensions", "setTimeout"], (function(a, b, c, d, e, f, g) {
    var h, i = "viewable_session_validation",
        j = [],
        k = {};
    ...
    function a(a, b, c) {
        try {
            ...
            l(e, b, c);
            !k[e].isValid ? m(e) && (k[e].enterTime = Date.now(), k[e].exitTime = null, k[e].isValid = !0) : m(e) || (k[e].isValid = !1, k[e].exitTime = Date.now())
        } catch (a) {
            (h || (h = d("ODS"))).bumpEntityKey(2966, i, "error.onViewUpdate." + a.message)
        }
    }
    ...
    function l(a, b, c) {
        ...
        c = c.right;
        var h = {};
        d = (d = (d = k[a]) == null ? void 0 : (d = d.boundaryDimensions) == null ? void 0 : d.ref) != null ? d : 0;
        switch (b) {
            case "top":
                h = {
                    top: e,
        ...
        k[a] = babelHelpers["extends"]({}, k[a], {
            boundaryDimensions: babelHelpers["extends"]({}, (b = k[a]) == null ? void 0 : b.boundaryDimensions, h)
        })
    }
    ...
    function m(a) {
        ...
        return a.top != null && a.bottom != null && a.top < a.bottom && a.top < d && a.bottom > f && a.left < a.right && a.left < e && a.right > 0
    }
    ...
    function p(a, b, e, f) {
        f === void 0 && (f = 1);
        try {
            var g, j = c("getCentralImpressionScrollSpeed")(),
            ...
            g = new(c("ViewableSessionValidationWebResultTypedLogger"))().setVerificationTime(Date.now()).setExtras(JSON.stringify({
                ...
                boundaryDimension: JSON.stringify((g = k[b].boundaryDimensions) != null ? g : "null"),
                viewportDimension: JSON.stringify(c("getViewportDimensions")())
            })).setFbFeedLocation(e).setSessionStartTime(k[b].enterTime).setSessionEndTime(k[b].exitTime).setPrimaryImpressionChannel("viewable_impression_tracker").setSecondaryImpressionChannel("two_div_boundary").setSessionKey(b).setScrollSpeed(j).setTimeFromLoad(l);
            if (o(b)) g.setVerifyResult(1), (h || (h = d("ODS"))).bumpEntityKey(2966, i, m + "pass");
            else {
                if (f > 0) {
            ...
            (h || (h = d("ODS"))).bumpEntityKey(2966, i, "error.onEventLogged." + a.message)
        }
    }
...
__d("GHLBox", ["FBLogger", "GhlTennisKnobsConfig", "Promise", "WebStorage", "gkx", "requireDeferred"], (function(a, b, c, d, e, f, g) {
    "use strict";
    var h, i, j = c("requireDeferred")("json-bigint").__setRef("GHLBox"),
    ...
    var q = function(a, b) {
        ...
        if (!b) {
            ...
            b = (d = (a = a.parse(d.getItem(l))) == null ? void 0 : a.session_key) != null ? d : "";
...
__d("ghlTestUBTFacebook", ["ConstUriUtils", "GHLBox", "Promise", "cr:1088657", "ghlInternalBumpODSKey", "promiseDone", "unrecoverableViolation"], (function(a, b, c, d, e, f, g) {
    ...
    var h, i = function(a) {
        ...
        k = function() {
            return new(h || (h = b("Promise")))(function(a) {
                ...
                c.src = i("https://scontent.xx.fbcdn.net/hads-ak-prn2/1487645_6012475414660_1439393861_n.png").toString()
            })
        },
        l = null;
    a = function(a) {
        l == null && (q("init"), l = new(h || (h = b("Promise")))(function(a) {
            return c("promiseDone")((h || (h = b("Promise"))).all([j(n), k(), j([o(p)]), d("GHLBox").r()]), function(b) {
                var c = b[0],
                    e = b[1],
                    f = b[2];
                b = b[3];
    ...
    var m = function(a) {
        ...
        p = ["UmVjdGFuZ2xlQWQ=", "YWR2ZXJ0aXNpbmdfd2lkZ2V0", "ZG93bmxvYWRfbGlua19zcG9uc29yZWQ=", "c3BvbnNvclBvc3Q=", "d2lkZ2V0U3BvbnNvcnM=", "b2ItaG92ZXI=", "ZGZwX3VuaXQ="],
        q = function() {
