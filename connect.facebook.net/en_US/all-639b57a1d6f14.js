/*1713941520,,JIT Construction: v1013005935,en_US*/
...
try {
                ...
                __d("fb-error", ["performanceNowSinceAppStart", "removeFromArray"], (function(a, b, c, d, e, f) {
                    ...
                    function va(a) {
                        ...
                        if (c !== e && typeof c === "object" && c !== null) {
                            ...
                            typeof c.message !== "string" && typeof c.messageFormat === "string" && (c.message = c.messageFormat, e = u(c));
                            if (typeof c.message !== "string" && typeof c.errorMsg === "string")
                                if (/^\s*\<!doctype/i.test(c.errorMsg)) {
                                    var f = /<title>([^<]+)<\/title>(?:(?:.|\n)*<h1>([^<]+)<\/h1>)?/im.exec(c.errorMsg);
                                    if (f) {
                                        var g;
                                        e = h('HTML document with title="%s" and h1="%s"', (g = f[1]) !== null && g !== void 0 ? g : "", (g = f[2]) !== null && g !== void 0 ? g : "")
                                    } else e = h("HTML document sanitized")
                                } else /^\s*<\?xml/i.test(c.errorMsg) ? e = h("XML document sanitized") : (c.message = c.errorMsg, e = u(c));
                            e !== c && typeof c.name === "string" && (e.name = c.name);
                            typeof c.name !== "string" && typeof c.errorCode === "string" && (e.name = "UnhandledRejectionWith_errorCode_" + c.errorCode);
                            typeof c.name !== "string" && typeof c.error === "number" && (e.name = "UnhandledRejectionWith_error_" + String(c.error))
                        }
                        e.loggingSource = "ONUNHANDLEDREJECTION";
                        e.name = e === c && e.name != null && e.name !== "" ? e.name : typeof(c === null || c === void 0 ? void 0 : c.name) === "string" && c.name !== "" ? c.name : d != null && d.length > 0 ? "UnhandledRejectionWith_" + d.join("_") : "UnhandledRejection_" + (c === null ? "null" : typeof c);
                        try {
                            f = c === null || c === void 0 ? void 0 : c.stack;
                            (typeof f !== "string" || f === "") && (f = e.stack);
                            (typeof f !== "string" || f === "") && (f = h("").stack);
                            e.stack = e.name + ": " + e.message + "\n" + f.split("\n").slice(1).join("\n")
                        } catch (a) {}
                        try {
                            g = a.promise;
                            e.stack = e.stack + (g != null && typeof g.settledStack === "string" ? "\n    at <promise_settled_stack_below>\n" + g.settledStack : "") + (g != null && typeof g.createdStack === "string" ? "\n    at <promise_created_stack_below>\n" + g.createdStack : "")
                        } catch (a) {}
                        b.reportError(e);
                        a.preventDefault()
                    }
    ...
    i.src = 'https://www.facebook.com/platform/scribe_endpoint.php/?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script || "all.js") + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"1013005935","namespace":"FB","message":"' + e.message + '"}}');
